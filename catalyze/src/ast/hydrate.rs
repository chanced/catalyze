...
impl Hydrator {
    ...
    fn hydrate_fields(
        ...
        nodes: &mut NodeMap,
        oneofs: &[oneof::Ident],
    ) -> Result<(Vec<field::Ident>, Vec<reference::ReferenceInner>), HydrationFailed> {
    ...
    fn hydrate_field(
        ...
        dependencies: &[Inner],
        nodes: &mut NodeMap,
    ) -> Result<(field::Ident, Option<reference::ReferenceInner>), HydrationFailed> {
        let Field {
            descriptor,
            fqn,
            location,
    ...
    ) -> Result<Vec<Inner>, HydrationFailed> {
